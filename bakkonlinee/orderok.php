...
<div>
     ...
     <img class="d-block justify-content-center mx-auto animate__animated animate__zoomIn animate__slow	2s " id="ok" src="admin/uploads/cashier.png"  style="width:150px; margin-top:50px; opacity: 1;  " alt="">
...
<?php
   ...
   header("Refresh:5; url=view-order");
