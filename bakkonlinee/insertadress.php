...
if(isset($_POST) & !empty($_POST)){
        ...
        $payment = filter_var($_POST['payment'], FILTER_SANITIZE_STRING);
			...
			$usql = "INSERT INTO usersmeta (firstname, lastname, il, ilce, cadde, apartman, daire, kat, mahalle, mobile, uid) VALUES ('$fname', '$lname', '$il', '$ilce', '$cadde', '$apartman', '$daire', '$kat', '$mahalle', '$phone', '$uid')";
...
<form method="post" class="needs-validation animate__animated animate__pulse " novalidate>

    <div class="container text-center adres font12">
        <h3 class="mt-2">Adres Bilgilerim</h3>
        ...
        <button class="btn btn-primary btn-lg btn-block mt-5 " type="submit">Kaydet</button>
